<div align="center">
  ...
  <div align="center" style="margin: 20px 0;"><span style="display: inline-block; text-align: center; margin: 0 40px;"><img src="shared/src/commonMain/composeResources/files/robot_animated.gif" alt="LoopSweep Cleaning State" width="180" height="180" style="background-image: url('data:image/svg+xml;base64,'); background-size: cover; border-radius: 8px;" /><br/><img src="https://img.shields.io/badge/▶_CLEANING-10B981?style=for-the-badge" alt="Cleaning State" style="margin-top: 10px;" /></span><span style="display: inline-block; text-align: center; margin: 0 40px;"><img src="shared/src/commonMain/composeResources/files/robot_static.png" alt="LoopSweep Paused State" width="180" height="180" style="background-image: url('data:image/svg+xml;base64,'); background-size: cover; border-radius: 8px;" /><br/><img src="https://img.shields.io/badge/⏸_PAUSED-222222?style=for-the-badge" alt="Paused State" style="margin-top: 10px;" /></span></div>
...
<div align="center">
  <img src="docs/images/kmp_compose_showcase_wide.png" alt="Compose Multiplatform Ecosystem" width="100%" style="aspect-ratio: 1024/510; background-image: url('data:image/svg+xml;base64,'); background-size: cover; border-radius: 12px;" />
</div>
...
sequenceDiagram
    ...
    participant VM as VacuumViewModel (Presentation)
    participant UC as CleanRoomUseCase (Domain)
    participant Repo as VacuumRepositoryImpl (Data)
    participant Client as VacuumClient (Network Data Source)
    participant Device as Physical Robot Vacuum (UDP Port 54321)

    User->>VM: Select Room & Tap Clean (roomId, repeats)
    VM->>UC: Invoke UseCase
    UC->>Repo: Execute cleanRoom(...)
    Repo->>Client: sendCommand(ip, token, roomId, repeats)
    Note over Client,Device: Handshake & Cryptography handshake
    Client->>Device: Send 32-byte UDP Hello Packet
    Device-->>Client: Return 32-byte Handshake response (DID + Stamp)
    Note over Client: Derive AES Key & IV via MD5<br/>Encrypt JSON payload with AES-128-CBC
    Client->>Device: Send Encrypted command packet + MD5 Checksum
    Device-->>Client: Return Encrypted Response / ACK
    Note over Client: Decrypt payload using derived keys
    Client-->>Repo: Return Result.success(JSON)
    Repo-->>UC: Return Success
    UC-->>VM: Update statusMessage State
    VM-->>User: Re-render UI with Glowing status & Active sweep
```
